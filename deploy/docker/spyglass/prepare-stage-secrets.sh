...
account_export_object_store_worker_access_key="$(secret_value SPYGLASS_ACCOUNT_EXPORT_OBJECT_STORE_WORKER_ACCESS_KEY access)"
account_export_object_store_worker_secret_key="$(secret_value SPYGLASS_ACCOUNT_EXPORT_OBJECT_STORE_WORKER_SECRET_KEY password)"
...
SPYGLASS_ACCOUNT_EXPORT_OBJECT_STORE_WORKER_ACCESS_KEY=$account_export_object_store_worker_access_key
SPYGLASS_ACCOUNT_EXPORT_OBJECT_STORE_WORKER_SECRET_KEY=$account_export_object_store_worker_secret_key
