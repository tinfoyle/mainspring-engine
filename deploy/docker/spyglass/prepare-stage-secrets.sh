...
account_provisioning_password="$(secret_value SPYGLASS_ACCOUNT_PROVISIONING_WORKER_DATABASE_PASSWORD password)"
...
operations_identity_password="$(secret_value SPYGLASS_OPERATIONS_IDENTITY_DATABASE_PASSWORD password)"
operations_projection_password="$(secret_value SPYGLASS_OPERATIONS_PROJECTION_DATABASE_PASSWORD password)"
operations_billing_password="$(secret_value SPYGLASS_OPERATIONS_BILLING_DATABASE_PASSWORD password)"
operations_privacy_password="$(secret_value SPYGLASS_OPERATIONS_PRIVACY_DATABASE_PASSWORD password)"
operations_affiliate_password="$(secret_value SPYGLASS_OPERATIONS_AFFILIATE_DATABASE_PASSWORD password)"
...
SPYGLASS_ACCOUNT_PROVISIONING_WORKER_DATABASE_PASSWORD=$account_provisioning_password
...
SPYGLASS_OPERATIONS_IDENTITY_DATABASE_PASSWORD=$operations_identity_password
SPYGLASS_OPERATIONS_PROJECTION_DATABASE_PASSWORD=$operations_projection_password
SPYGLASS_OPERATIONS_BILLING_DATABASE_PASSWORD=$operations_billing_password
SPYGLASS_OPERATIONS_PRIVACY_DATABASE_PASSWORD=$operations_privacy_password
SPYGLASS_OPERATIONS_AFFILIATE_DATABASE_PASSWORD=$operations_affiliate_password
...
SPYGLASS_ACCOUNT_PROVISIONING_GLOBAL_DATABASE_URL=postgres://spyglass_account_provisioning_worker:$account_provisioning_password@global-db:5432/spyglass?sslmode=disable
SPYGLASS_CELL_A_ACCOUNT_PROVISIONING_DATABASE_URL=postgres://spyglass_account_provisioning_worker:$account_provisioning_password@cell-a-db:5432/spyglass?sslmode=disable
SPYGLASS_CELL_B_ACCOUNT_PROVISIONING_DATABASE_URL=postgres://spyglass_account_provisioning_worker:$account_provisioning_password@cell-b-db:5432/spyglass?sslmode=disable
...
SPYGLASS_OPERATIONS_IDENTITY_DATABASE_URL=postgres://spyglass_operations_identity:$operations_identity_password@global-db:5432/spyglass?sslmode=disable
SPYGLASS_OPERATIONS_PROJECTION_DATABASE_URL=postgres://spyglass_operations_projection:$operations_projection_password@global-db:5432/spyglass?sslmode=disable
SPYGLASS_OPERATIONS_BILLING_DATABASE_URL=postgres://spyglass_operations_billing:$operations_billing_password@global-db:5432/spyglass?sslmode=disable
SPYGLASS_OPERATIONS_PRIVACY_DATABASE_URL=postgres://spyglass_operations_privacy:$operations_privacy_password@global-db:5432/spyglass?sslmode=disable
SPYGLASS_OPERATIONS_AFFILIATE_DATABASE_URL=postgres://spyglass_operations_affiliate:$operations_affiliate_password@global-db:5432/spyglass?sslmode=disable
