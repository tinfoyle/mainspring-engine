...
for service in app-api-a app-api-b admission-api agent-dispatch-worker-a agent-dispatch-worker-b schedule-execution-worker-a schedule-execution-worker-b; do
