export function ProductPreview() {
  return <div className="product-preview" role="img" aria-label="Illustration of the Spyglass operating workspace showing work metrics and a governed agent suggestion">
