...
export default function PricingPage() {
  return <main><SiteHeader /><PageIntro eyebrow="Simple starting points" title="Start with clarity. Pay when Spyglass starts carrying real work." body="Every Account begins free. Paid plans add packages, members, and operating capacity; your data remains yours through every change." /><section className="content-section shell"><PricingCards /></section><SiteFooter /></main>;
}
