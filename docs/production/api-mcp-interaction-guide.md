...
- HTTP contract: `api/spyglass.openapi.json` (210 operations)
...
| Billing and Catalog | 6 | public Catalog, billing status, AI Token balance, checkout, portal and Stripe webhook |
