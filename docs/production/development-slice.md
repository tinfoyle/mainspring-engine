...
- OpenAPI 3.1 route ownership and drift enforcement for every customer-facing Account/cell route, with resolved-reference validation; exact public Catalog, registration, login, Account-choice/selection, cell Account-context, Work, and Agents query/header/body/status/response contracts; generated Go route maturity; and generated TypeScript route/schema inventories.
