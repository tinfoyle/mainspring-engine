...
- A three-database PostgreSQL 17 routing contract covering two physical cells, Account placement and generation-advanced movement, wrong-cell/cross-Account proof attacks, stale pre-move proofs, assigned-cell outage without fallback, and fail-closed disabled-cell cache refresh.
