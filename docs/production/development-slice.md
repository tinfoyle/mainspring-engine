...
- OpenAPI 3.1 route ownership and drift enforcement for all 56 customer-facing Account/cell operations, with resolved-reference validation; exact public acquisition, identity security, Account selection, Membership/invitation/ownership, lifecycle, Billing, webhook receipt, cell Account-context, Work, and Agents success contracts; no-generic-response and bounded backward-compatibility regression gates; generated Go route maturity; generated TypeScript route/schema inventories; and public pricing bound to generated Catalog types behind runtime validation.
