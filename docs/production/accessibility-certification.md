...
1. Expand the exact-artifact browser job from its complete multi-engine public inventory and primary private workspace checkpoint to Vue signup, verification, login and owner enrollment plus additional validation, denial and transition states at every required width; cover target size, forward and backward focus order, every drawer/dialog boundary, skip-link movement, zoom/reflow and forced colors.
