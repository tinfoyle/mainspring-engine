...
1. Expand the exact-artifact browser job from its complete multi-engine public inventory and private Your Turn/Checkout/Privacy/Affiliate/Security checkpoint to Vue signup, verification, login, owner enrollment, Work, Knowledge, Baseline, Agents, Schedules, Finance, Integrations, Account, Billing, Account exports and Account lifecycle routes at every required width; cover target size, forward and backward focus order, every drawer/dialog boundary, skip-link movement, zoom/reflow and forced colors.
