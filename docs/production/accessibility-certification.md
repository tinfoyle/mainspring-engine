...
1. Expand the exact-artifact browser job from its complete multi-engine public inventory and private Your Turn/Checkout/Privacy/Affiliate/Security/Account-administration/Work/Knowledge/Baseline checkpoint to Vue signup, verification, login, owner enrollment, Agents, Schedules, Finance and Integrations routes plus additional Work, Knowledge, Baseline, Account, Billing, export and closure states at every required width; cover target size, forward and backward focus order, every drawer/dialog boundary, skip-link movement, zoom/reflow and forced colors.
2. Expand real-browser axe coverage to additional private validation/denial/conflict/capacity/loading/recoverable-failure states and mobile WebKit/device profiles. Retain the legacy structural gates as rollback evidence, not as evidence for Vue parity.
