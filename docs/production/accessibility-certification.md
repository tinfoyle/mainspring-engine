...
2. Add real-browser axe coverage to both new UI artifacts and expand private Vue rendered-state fixtures through validation, denial, conflict, capacity, loading and recoverable-failure states. Retain the legacy structural gates as rollback evidence, not as evidence for Vue parity.
