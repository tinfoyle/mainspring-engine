...
- Status: Knowledge review surface, document lifecycle foundation, immutable source/extracted storage and bounded malware/extraction adapters implemented; processing worker, routed document operations and retrieval next
- Phase: 3.2
