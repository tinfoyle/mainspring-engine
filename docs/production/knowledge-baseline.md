...
- Status: Knowledge review surface, document lifecycle foundation, durable processing workers and routed upload/list/detail/publish/delete operations implemented; physical deletion reconciliation and retrieval next
- Phase: 3.2
