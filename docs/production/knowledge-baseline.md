...
- Status: Knowledge review surface and the complete document admission, processing, retrieval/citation and physical-deletion path implemented; Baseline lifecycle next
- Phase: 3.2
