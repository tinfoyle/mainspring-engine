...
1. Add two-cell attack/failover fixtures and certificate-rotation canaries to the directory-routed, workload-authenticated boundary described in [routing-boundary.md](routing-boundary.md); admission API remains private.
