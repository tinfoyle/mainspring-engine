...
- Status: GDPR-capable analytics and Affiliate construction complete locally; legal, real-provider and operational release gates remain closed
...
The immutable earning ledger remains independent of settlement. The exact hybrid mode and balance-integrity controls are implemented locally, and the UI keeps pending earnings distinct from available credit. Because enrollment is closed, the public terms describe check eligibility without making an operative payment promise; final legal terms and the Support procedure remain release gates.

Launch pricing is $50.00 USD per month per team plus an optional $250.00 USD one-time onboarding/commissioning package, before applicable Stripe-calculated tax. There is no Free plan. The optional package, AI Token top-ups and promotional Token grants are never Affiliate-commission eligible. Their line amounts are excluded even when they share an invoice with the subscription, and adverse evidence confined to those lines cannot reverse a subscription earning. The obsolete `free-v1`, `$49` Team and `$149` Operating candidates are absent from the effective launch Catalog and customer surfaces. Exact immutable local Catalog identities, the private Price-mapping model and the line-item-aware Affiliate projection are encoded and verified; real provider Price identities remain deployment-specific release inputs.

The $50 subscription unlocks every completed launch package and feature. There are no paid software tiers or feature add-ons. Capacity and concurrency controls remain service-protection limits, not separate product offers. Commissioning provides service only and changes no software entitlement.

Launch does not expose Kimi, Z.ai or model names as selectable products. Agent customization instead offers a labeled simple-to-advanced complexity setting whose discrete class maps internally to a certified provider/model and AI Token rate. Infinite Ocean may change those mappings prospectively after reviewed quality, tool-use, privacy/no-storage, reliability, normalized-usage and cost certification. Each admitted Run remains bound to its original complexity, internal execution and rate versions; privacy notices and the subprocessor record still disclose applicable provider processing as legally required.

AI Token subscription grants, top-up quantities/prices and promotions are versioned prospective commercial records rather than a permanent exchange rate. The local construction seed is 10,000 per renewal and 10,000 for a $10 top-up, but release may publish different quantities or prices. Promotions append labeled bounded grants. Historical purchases, grants and debits remain immutable, and optional analytics consent never controls the necessary balance ledger.

When access is restricted after cancellation or nonpayment, the remaining AI Token grants stay visible through necessary billing/privacy/export processing but cannot fund new work. Recovery before Account deletion restores any surviving purchased balance; included and promotional balances continue under their normal expiry rules. Guarded deletion extinguishes all remaining balances without cash value, refund or migration to a replacement Account except where applicable law requires otherwise.

AI Token grants are team-Account records rather than member property. Membership and Account-owner changes preserve that Account's ledger, but no customer, API or Support path transfers a grant to another Account, even under common ownership. Corrections remain auditable entries in the original Account; mergers, splits and replacements receive case-by-case commercial review without automated token migration.

An authorized owner or billing administrator with recent passkey confirmation may request a top-up refund through Support within 14 calendar days only while that exact purchased grant is wholly unused and unreserved. Any consumption makes it ineligible for full or partial discretionary refund. Included and promotional grants are never refundable. Confirmed Stripe refunds append an idempotent full-grant reversal; duplicate charges, fraud, technical billing errors and remedies required by law remain separate exception handling.

The AI Token balance is a necessary shared team record. Active members can inspect safe aggregate availability, reservation and origin information, but each consuming action still requires its normal package, role and object authority. Only owners and billing administrators with recent passkey evidence may manually buy top-ups or initiate refund review, and launch performs no automatic replenishment. Insufficient balance stops work before provider contact and preserves the customer input without creating debt.

Included grants project exactly once from a signed successfully paid positive initial/renewal service-period invoice and keep their configured quantity regardless of discount or tax. Top-ups project their purchased Catalog quantity exactly once. Prorations, retries and commissioning cannot duplicate included Tokens. Top-up and promotional Tokens never earn Affiliate commission. Open top-up disputes freeze unused value; won disputes restore it, while a Refund, reversed payment or final lost dispute appends a remainder reversal without rewriting settled use.

Comparable same-complexity rate increases receive 30 days' customer notice. Urgent security, legal, provider-withdrawal or severe-reliability replacement may take immediate effect with notice as soon as practicable; admitted Runs remain frozen. Promotions are immutable, bounded, explicit-expiry campaign records with exact audience, window, redemption/issuance caps, price/quantity effect, disclosure and stacking rules. They do not apply retroactively or stack unless published to do so, and an Affiliate code is attribution rather than a token promotion.

Included Tokens expire without rollover when the next successful renewal grant is posted. Purchased top-ups do not expire while the team Account remains active. Promotional grants carry an explicit published expiration. The ledger consumes earliest-expiring grants first and preserves purchased Tokens until last; reservations, settlement and release retain each grant's origin. Expiry is necessary commercial processing and is independent of analytics/marketing consent.
...
Voluntary cancellation preserves paid access until period end. Actual termination then restricts access and starts the same 30-day deletion clock; projected resubscription before deletion cancels it. Necessary-service email and in-app notices occur at cancellation scheduling, term end, clock day 23 and day 29 and carry the exact term/deletion time, resubscription, export and conditional identity-erasure disclosures.
...
Local acceptance checkpoint (2026-08-25; completion update 2026-08-27): the service, PostgreSQL lifecycle and exact-build browser suites automate consent-independent referral, self-referral denial, suspended-code behavior, invoice replay, recurring-cycle maturity, Refund/credit-note/final-lost-dispute reversal, settlement compensation and referred-customer concealment. The final exact-artifact UI gate passes 413 applicable browser checks with eleven intentional profile-specific skips across desktop engines, three phone widths, 320-pixel reflow, tablet, forced colors, reduced motion, text enlargement and 400% browser-scale reflow; all Go, PostgreSQL, contract and clean-bootstrap gates pass separately. This closes local synthetic/adversarial construction evidence for approved economics and settlement. It does not open the Affiliate flags or replace legal/vendor/transfer review, hosted Stripe rehearsal, physical-device use, assistive-technology certification or owner visual acceptance.
