...
|---|---|---|
| Application | `0.3.0-rc.45` | `ghcr.io/tinfoyle/spyglass-engine@sha256:6a304079864ef60487c1393126507f70335211a870a56c10d621eed4190d434b` |
| Public UI | `0.3.0-rc.45` | `ghcr.io/tinfoyle/infinite-ocean-public-ui@sha256:30f38a958fcf148e75038d9b6123a1859d9e4c1126b652a688054cb7fca09285` |
| Private UI | `0.3.0-rc.45` | `ghcr.io/tinfoyle/infinite-ocean-private-ui@sha256:cb7fb1e96e078c2ebdddc665b66db9898a6a3069468adc5db6c2ef19de9b9795` |

The RC.45 triple was built from source revision
`3bcb3bdf2dd60665296134312a2bf8604292cf42` and is tracked in
`deploy/releases/0.3.0-rc.45.env`. It passed local AMD64 admission and connected
...
The historical connected-stage RC.5 -> RC.4 -> RC.5 rehearsal completed successfully against retained PostgreSQL volumes. RC.4 and the restored RC.5 each passed the same 11-check exact-origin/Catalog boundary certificate. RC.5 remains the Phase 2.5 platform rollback baseline; RC.45 is active on Stage, and its expanded schema does not inherit that earlier downgrade proof. The final production release will be a later signed immutable triple; no current candidate is predeclared as that release.
