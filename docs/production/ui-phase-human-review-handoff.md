...
- **Decided 2026-08-26:** expose one provider-neutral Standard AI service at launch with no customer model/provider selector. Internal substitutions require reviewed certification and affect future admissions only; each Run freezes its execution and rate versions;
...
AI presentation: one Standard AI service, no provider/model selector; certified substitutions affect future Runs only (owner decision 2026-08-26)
