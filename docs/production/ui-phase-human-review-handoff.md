...
- **Corrected 2026-08-26:** do not expose provider/model names, but give each Agent a labeled discrete simple-to-advanced complexity setting. Each class maps to a certified internal model/provider and distinct AI Token rate; Runs freeze complexity, execution and rate versions;
...
AI presentation: provider/model names hidden; per-Agent discrete simple-to-advanced complexity maps to certified internal models/rates; Runs freeze versions (owner correction 2026-08-26)
