...
3. **Isolation and load.** Run many-small-Account and one-hot-Account profiles through at least two router and cell replicas. Record latency histograms, errors, queue ages, database connections, HPA decisions, and fairness. Include wrong-Account, wrong-cell, stale-placement, stale-entitlement, replay, and downstream-saturation attacks.
