...
| Baseline assessment and maintenance | eighteen Baseline and source-grant operations, including current-assessment discovery | five typed Baseline tools, separated by Knowledge and Integrations authority | baseline-maintenance worker | deterministic plan/Work materialization, renewal/reassessment and source-scope tests |
