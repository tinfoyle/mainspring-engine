...
4. **Observability and incident response.** Add OpenTelemetry traces/metrics, safe Account/cell correlation, queue-age and projection-lag dashboards, paging thresholds, ownership, and executable runbooks. Complete a staging burn-in and one game day.
