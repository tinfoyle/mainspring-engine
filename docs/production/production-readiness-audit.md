...
1. Finish the interactive Agents orchestration beyond the executable Conversation/Message reads and one ordered Persona pass, plus schedules, attachments, and customer retry/manual-resolution paths. Dispatch/projection dead-letter inspection and exact-target operator requeue are executable; they still require staging role and runbook rehearsal.
