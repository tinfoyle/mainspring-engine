...
UI7 has not exited. The short-lived public-to-private conversion receipt, authenticated rendered coverage for Your Turn and all private package routes, authenticated reflow/forced-color checks, rendered offline/session-expiry/conflict recovery, real iOS Safari and Android Chrome, and provider-backed checkout/security journeys remain open. These are construction/certification tasks, not authorization to publish or deploy.
