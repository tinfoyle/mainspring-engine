...
- Migrate Finance, Marketing, Integrations, billing and Baseline surfaces; retain the completed Affiliate, Scheduling, Account-team, Security, export and Account-lifecycle routes as UI6 reference implementations.
