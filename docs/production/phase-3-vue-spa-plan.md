...
- Migrate Finance, Marketing, Integrations, billing, membership, security, export and Account lifecycle surfaces; retain the completed Affiliate and Scheduling routes as UI6 reference implementations.
