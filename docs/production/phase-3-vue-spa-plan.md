...
- Migrate Marketing and Baseline surfaces; retain the completed Affiliate, Scheduling, Account-team, Billing, Finance, Integrations, Security, export and Account-lifecycle routes as UI6 reference implementations.
