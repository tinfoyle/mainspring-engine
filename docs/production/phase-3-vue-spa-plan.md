...
- Migrate Finance, Marketing, Integrations and Baseline surfaces; retain the completed Affiliate, Scheduling, Account-team, Billing, Security, export and Account-lifecycle routes as UI6 reference implementations.
