...
- Ambiguous delivery may require a human decision, which is safer than duplicate external effects.
...
- PostgreSQL tests prove forced RLS, exact Account relationships, immutable revisions/attempts/events, claim leasing, retry versus reconcile admission, lost-lease behavior, credential revocation, movement fencing and erasure accounting.
