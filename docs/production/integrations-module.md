...
This opens only the deterministic local certification path. Stage and production remain closed until governed immutable-object upload/read, composition and environment certification of the constructed mounted broker, and real closed-capability provider adapters are constructed and certified.
