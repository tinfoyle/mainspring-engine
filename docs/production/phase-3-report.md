...
Implementation checkpoint (2026-08-21): the composite Account/Persona foreign key, active published Persona assignment policy, routed Persona assignment input, additive provenance and Conversation-link commands, Account-scoped Conversation/Run foreign keys, typed redacted mutation events, generated client contracts and erasure-safe deferred integrity behavior are complete. Assignment editing UI, scale/concurrency evidence, draft/accessibility work and prototype migration remain.
