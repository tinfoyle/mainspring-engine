...
Implementation checkpoint (2026-08-21): the composite Account/Persona foreign key, active published Persona assignment policy, routed Persona assignment input, generated client contract and erasure-safe deferred integrity behavior are complete. Assignment editing UI, provenance/conversation commands, scale/concurrency evidence, draft/accessibility work and prototype migration remain.
