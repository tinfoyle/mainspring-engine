...
func TestPostgresCellErasureIsExactIdempotentAndContentFree(t *testing.T) {
	...
	for _, table := range []string{"knowledge_documents", "knowledge_document_revisions", "knowledge_document_chunks", "knowledge_document_events"} {
		coveredTables[table] = true
	}
