...
func TestPostgresRestoreReplayRebuildsPinnedErasureCheckpoints(t *testing.T) {
	...
	if _, err := restored.Exec(ctx, `CREATE ROLE `+globalFunctionRole+` NOLOGIN NOBYPASSRLS; CREATE ROLE `+globalOperatorRole+` NOLOGIN NOBYPASSRLS;
		...
		ALTER FUNCTION public.spyglass_replay_account_cell_erasure_without_agent_queue_admin(uuid,uuid,bigint,bigint,bytea,bigint,bigint,text,timestamptz,bytea,bytea,timestamptz,bigint,bytea,bigint,bytea) OWNER TO `+cellFunctionRole+`;
		ALTER FUNCTION public.spyglass_replay_account_cell_erasure_without_agent_run_resolutions(uuid,uuid,bigint,bigint,bytea,bigint,bigint,text,timestamptz,bytea,bytea,timestamptz,bigint,bytea,bigint,bytea) OWNER TO `+cellFunctionRole+`;
		ALTER FUNCTION public.spyglass_replay_account_cell_erasure_without_movement_fence(uuid,uuid,bigint,bigint,bytea,bigint,bigint,text,timestamptz,bytea,bytea,timestamptz,bigint,bytea,bigint,bytea) OWNER TO `+cellFunctionRole+`;
