...
onMounted(async () => {
  try {
    ...
    await emitAnalytics(consent.decided && consent.analytics && !consent.renewal_required, { name: "landing_viewed", fields: { route_name: "landing" } });
  } catch {
  ...
  <div>
    <section class="hero">
      ...
      <div class="hero__inner">
        ...
        <div class="hero__actions"><a class="button button--primary" :href="`${appOrigin}/signup`">Start free</a><NuxtLink class="button button--secondary" to="/features">See how it works</NuxtLink></div>
    ...
    <section class="closing-cta section-frame"><p class="eyebrow">Start with clarity</p><h2>Bring the business you have.<br />Build the operating system it needs.</h2><a class="button button--primary" :href="`${appOrigin}/signup`">Create your free Account</a></section>
  </div>
</template>
