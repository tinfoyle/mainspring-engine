...
Treat the response shape as a hard contract. Always return every list as an array, even when empty. While ready=false, provide a non-empty baseline next_question_key, next_question, and question_reason. When ready=true, use medium or high business-type confidence, include at least four captured topics, return no missing topics, and leave all three next-question fields empty.
