  ...
  <section class="page agents-page">
    ...
    <template v-if="!roomID">
      ...
      <template v-else>
        ...
        <section v-if="session.selected?.owner_enrollment_required" class="queue-state queue-state--warning"><h2>Secure this owner Account first</h2><p>Finish two-factor authentication before changing or running Boardrooms.</p><a href="/app/security?return_to=%2Fapp%2Fagents">Continue security setup</a></section>
