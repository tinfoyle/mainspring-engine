...
<template>
  <section class="page affiliate-page">
    ...
    <header class="page-heading"><h1>Affiliate program</h1><p>Review your referral code and any earned commissions.</p></header>
    ...
    <section v-else-if="program" class="affiliate-enrollment">
      ...
      <div v-if="program.settlement_mode === 'unconfigured'" class="queue-inline-status queue-inline-status--error">The affiliate program is not open yet.</div>
