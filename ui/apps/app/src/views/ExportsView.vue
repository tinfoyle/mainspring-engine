...
<template>
  <section class="page exports-page">
    ...
    <header class="page-heading"><h1>Exports</h1><p>Download your account data as a ZIP file. Completed exports are available for seven days.</p></header>
    ...
    <template v-else>
      ...
      <section class="export-request"><div><h2>Request Account export</h2><p>Requires an identity confirmation from the last ten minutes. Only one build may be active for an Account.</p></div><IoButton :disabled="saving" @click="begin('create')">Request export</IoButton></section>
      <section class="export-history">
        <header><div><h2>Export history</h2></div><span>{{ exports.length }} records</span></header>
