...
func main() {
	...
	outputs := map[string][]byte{
		"ui/packages/api/src/generated/agent-tool-catalog.ts": append(append([]byte("// Code generated by apicontract. DO NOT EDIT.\nexport const agentToolCatalog = "), bytes.TrimSpace(agenttools.CatalogJSON)...), []byte(" as const;\n")...),
