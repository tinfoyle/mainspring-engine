...
func AccountExportCellProjectionTables(tx pgx.Tx) map[string][]AccountExportProjectionTable {
	result := map[string][]AccountExportProjectionTable{
		...
		"agents": {
			projectionTable(tx, "spyglass", "agent_boardrooms", "account_id", []string{"account_id", "id"}, []string{"account_id", "id", "name", "purpose", "state", "version", "created_at", "updated_at", "manager_persona_id"}, nil),
			projectionTable(tx, "spyglass", "agent_conversations", "account_id", []string{"account_id", "id"}, []string{"account_id", "id", "boardroom_id", "subject", "state", "created_by", "created_at", "updated_at"}, []string{"next_message_sequence"}),
			projectionTable(tx, "spyglass", "agent_invocation_execution_plans", "account_id", []string{"account_id", "invocation_id"}, []string{"account_id", "invocation_id", "conversation_id", "context_sequence", "profile", "created_at"}, []string{"model_operation_ids", "tool_operation_ids", "request_expires_at"}),
			projectionTable(tx, "spyglass", "agent_invocations", "account_id", []string{"account_id", "id"}, []string{"account_id", "id", "run_id", "turn", "persona_version_id", "status", "expected_provider", "requested_model", "response_model", "result_digest", "result_payload", "input_tokens", "output_tokens", "total_tokens", "failure_code", "queued_at", "started_at", "completed_at", "cost_micros", "permitted_models", "selected_model", "result_policy_version"}, []string{"provider_response_id", "runner_result_digest"}),
			projectionTable(tx, "spyglass", "agent_messages", "account_id", []string{"account_id", "id"}, []string{"account_id", "id", "conversation_id", "run_id", "invocation_id", "sequence", "role", "persona_version_id", "body", "structured_result", "result_digest", "created_at"}, nil),
			projectionTable(tx, "spyglass", "agent_personas", "account_id", []string{"account_id", "id"}, []string{"account_id", "id", "boardroom_id", "state", "latest_version", "created_at", "updated_at"}, nil),
			projectionTable(tx, "spyglass", "agent_persona_versions", "account_id", []string{"account_id", "id"}, []string{"account_id", "id", "persona_id", "version", "name", "role", "description", "system_instructions", "policy", "content_digest", "created_by", "created_at"}, nil),
			projectionTable(tx, "spyglass", "agent_runs", "account_id", []string{"account_id", "id"}, []string{"account_id", "id", "boardroom_id", "conversation_id", "state", "entitlement_version", "policy_version", "plan_digest", "turn_count", "created_by", "created_at", "started_at", "completed_at", "context_payload", "context_digest", "context_item_count", "mode"}, nil),
			projectionTable(tx, "spyglass", "agent_run_plan_turns", "account_id", []string{"account_id", "run_id", "turn"}, []string{"account_id", "run_id", "turn", "persona_id", "persona_version_id", "persona_digest"}, nil),
			projectionTable(tx, "spyglass", "agent_run_resolutions", "account_id", []string{"account_id", "id"}, []string{"account_id", "id", "run_id", "action", "note", "actor_user_id", "retry_run_id", "created_at"}, nil),
			projectionTable(tx, "spyglass", "agent_user_messages", "account_id", []string{"account_id", "id"}, []string{"account_id", "id", "conversation_id", "sequence", "body", "created_by", "created_at"}, nil),
			projectionTable(tx, "spyglass", "runner_action_attempts", "account_id", []string{"account_id", "attempt_id"}, []string{"account_id", "operation_id", "attempt_id", "mode", "outcome", "error_code", "started_at", "completed_at"}, []string{"lease_expires_at", "executor_id", "executor_version", "executor_policy_version"}),
			projectionTable(tx, "spyglass", "runner_action_authorizations", "account_id", []string{"account_id", "operation_id"}, []string{"account_id", "operation_id", "invocation_id", "approval_id", "capability", "input_sha256", "hash_version", "evidence_sha256", "proposer_kind", "proposer_id", "approved_by_user_id", "policy_version", "state", "approved_at", "expires_at", "canceled_at"}, nil),
			projectionTable(tx, "spyglass", "runner_action_ledger", "account_id", []string{"account_id", "operation_id"}, []string{"account_id", "operation_id", "invocation_id", "capability", "input_sha256", "state", "attempt_count", "last_error_code", "started_at", "updated_at", "completed_at"}, []string{"idempotency_key", "current_attempt_id", "lease_expires_at", "executor_id", "executor_version", "executor_policy_version", "next_attempt_at"}),
			projectionTable(tx, "spyglass", "runner_action_manual_resolutions", "account_id", []string{"account_id", "resolution_id"}, []string{"account_id", "resolution_id", "operation_id", "requested_outcome", "reason_sha256", "requested_by_user_id", "requested_at", "state", "confirmed_by_user_id", "confirmed_at"}, nil),
			projectionTable(tx, "spyglass", "runner_capability_events", "account_id", []string{"account_id", "event_id"}, []string{"account_id", "event_id", "invocation_id", "operation_id", "capability", "effect", "decision", "error_code", "occurred_at"}, []string{"pod_uid"}),
		},
		"attention": {
		...
		"integrations": {
			...
			projectionTable(tx, "spyglass", "integration_connection_revisions", "account_id", []string{"account_id", "id"}, []string{"account_id", "id", "connection_id", "revision", "capabilities", "email_address", "audience_reference", "https_origin", "path_prefix", "drive_folder_ids", "created_by_user_id", "created_at"}, nil),
		...
		"knowledge": {
			projectionTable(tx, "spyglass", "knowledge_claim_citations", "account_id", []string{"account_id", "claim_id", "evidence_id"}, []string{"account_id", "claim_id", "evidence_id", "evidence_kind", "relation", "locator", "created_at"}, nil),
			projectionTable(tx, "spyglass", "knowledge_claims", "account_id", []string{"account_id", "id"}, []string{"account_id", "id", "scope_kind", "scope_work_item_id", "scope_conversation_id", "fact_key", "canonical_value", "value_sha256", "hash_version", "confidence", "sensitivity", "proposed_by_kind", "proposed_by_id", "state", "decision_reason", "decided_by_user_id", "decided_at", "version", "created_at", "updated_at"}, nil),
			projectionTable(tx, "spyglass", "knowledge_documents", "account_id", []string{"account_id", "id"}, []string{"account_id", "id", "title", "sensitivity", "current_revision_id", "current_revision", "state", "retain_until", "legal_hold", "version", "created_by_kind", "created_by_id", "created_at", "updated_at", "deletion_requested_at", "deleted_at"}, nil),
			projectionTable(tx, "spyglass", "knowledge_document_events", "account_id", []string{"account_id", "id"}, []string{"account_id", "id", "aggregate_kind", "document_id", "revision_id", "event_type", "from_version", "to_version", "actor_kind", "actor_id", "reason_code", "correlation_id", "redacted_payload", "occurred_at"}, nil),
			projectionTable(tx, "spyglass", "knowledge_document_revisions", "account_id", []string{"account_id", "id"}, []string{"account_id", "id", "document_id", "revision", "filename", "declared_media_type", "verified_media_type", "byte_size", "content_sha256", "change_summary", "state", "scan_state", "scan_engine", "scan_signature", "scanned_at", "extraction_state", "extractor", "text_sha256", "text_bytes", "extracted_at", "index_state", "index_generation", "chunk_count", "indexed_at", "failure_code", "created_by_kind", "created_by_id", "created_at", "updated_at"}, []string{"object_key", "object_version", "extracted_object_key", "extracted_object_version"}),
			projectionTable(tx, "spyglass", "knowledge_events", "account_id", []string{"account_id", "id"}, []string{"account_id", "id", "aggregate_kind", "evidence_id", "claim_id", "fact_id", "event_type", "from_version", "to_version", "actor_kind", "actor_id", "reason_code", "correlation_id", "redacted_payload", "occurred_at"}, nil),
			projectionTable(tx, "spyglass", "knowledge_evidence", "account_id", []string{"account_id", "id"}, []string{"account_id", "id", "source_kind", "source_reference", "source_revision", "content_sha256", "captured_at", "created_by_kind", "created_by_id", "created_at"}, nil),
			projectionTable(tx, "spyglass", "knowledge_facts", "account_id", []string{"account_id", "id"}, []string{"account_id", "id", "scope_kind", "scope_work_item_id", "scope_conversation_id", "fact_key", "current_claim_id", "state", "revision", "accepted_by_user_id", "accepted_at", "created_at", "updated_at"}, nil),
			projectionTable(tx, "spyglass", "knowledge_fact_revisions", "account_id", []string{"account_id", "fact_id", "revision"}, []string{"account_id", "fact_id", "revision", "claim_id", "accepted_by_user_id", "accepted_at"}, nil),
		},
		"migration": {
