...
func TestKnowledgeRouteAllowlistMatchesCellSurface(t *testing.T) {
	tests := []struct {
		...
		{http.MethodPost, "knowledge/retrieval", false, true},
		{http.MethodGet, "knowledge/documents/" + routerRequest, false, true},
		{http.MethodGet, "knowledge/documents/" + routerRequest + "/revisions/" + routerRequest + "/chunks/" + routerRequest, false, true},
