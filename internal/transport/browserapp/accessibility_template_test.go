...
func TestPrivateBrowserTemplatesHaveAccessiblePageFrames(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "empty Your Turn", page: "your-turn", data: pageData{Title: "Your Turn", Page: "your-turn"}, currentNav: true},
		{name: "locked Your Turn", page: "your-turn", data: pageData{Title: "Your Turn", Page: "your-turn", Selected: &choice, Choices: []accountaccess.Choice{choice}}, currentNav: true},
		{name: "Work Your Turn", page: "your-turn", data: pageData{Title: "Your Turn", Page: "your-turn", Selected: &choice, Choices: []accountaccess.Choice{choice}, AttentionAvailable: true, WorkAvailable: true}, currentNav: true},
		{name: "full Your Turn", page: "your-turn", data: pageData{Title: "Your Turn", Page: "your-turn", Selected: &choice, Choices: []accountaccess.Choice{choice}, AttentionAvailable: true, WorkAvailable: true, ApprovalsAvailable: true}, currentNav: true},
