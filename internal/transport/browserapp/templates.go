...
<div class="app-shell">
  ...
  <main class="workspace" id="main-content" tabindex="-1">
    ...
    <div class="content integrations-content">
      ...
      <dialog class="integrations-dialog" id="integrations-connection-dialog"><form id="integrations-connection-form"><header><div><p class="eyebrow">NON-SECRET SCOPE</p><h2 id="integrations-connection-form-title">New connection</h2></div><button type="button" data-close-integrations aria-label="Close">×</button></header><label>Name<input name="name" maxlength="160" required></label><div class="integrations-form-grid"><label>Connector<select name="kind"><option value="email">Email</option><option value="web_publish">Web publication</option></select></label><label>Capabilities<select name="capabilities" multiple required><option value="email.read">Email read</option><option value="email.send">Email send</option><option value="web.publish">Web publish</option></select></label></div><label>Email address<input name="email_address" maxlength="320"></label><label>Audience reference<input name="audience_reference" maxlength="500"></label><label>HTTPS origin<input name="https_origin" type="url" maxlength="500"></label><label>Path prefix<input name="path_prefix" maxlength="500"></label><p class="integrations-note">Provider credentials are not accepted in this form.</p><p class="integrations-error" role="alert" hidden></p><footer><button type="button" data-close-integrations>Cancel</button><button type="submit">Save scope</button></footer></form></dialog>
