...
func TestValidateConfigFailsClosed(t *testing.T) {
	...
	config := Config{DatabaseURL: "postgres://example", Action: "inspect", Queue: application.QueueDispatch, Actor: "operator", Reason: "investigate dead letters", Environment: "production", ConfirmEnvironment: "staging"}
